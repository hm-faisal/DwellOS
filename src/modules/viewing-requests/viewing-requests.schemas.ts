...
export type CreateViewingRequestInput = z.infer<typeof createViewingRequestSchema>['body'];
export type UpdateViewingRequestInput = z.infer<typeof updateViewingRequestSchema>['body'];
