...
async function seed() {
	...
	const users = [
		...
		{
			id: 'd4edc957-e5dc-4267-b156-1c37c2262255',
		...
		{
			id: '7973abc1-0492-4496-a633-f488c179caba',
			...
			status: 'ACTIVE',
			stripeCustomerId: null,
			stripeAccountId: 'acct_mock_owner_io',
		},
		{
			id: 'dc617205-d159-48bc-be73-4ab0752888a5',
			email: 'tenant1@dwellos.io',
			password: await bcrypt.hash('TenantPassword123!', 10),
			name: 'Alex Tenant',
			phone: '+15550000008',
			role: 'TENANT',
			status: 'ACTIVE',
			stripeCustomerId: 'cus_mock_alex_io',
			stripeAccountId: null,
		},
	];
